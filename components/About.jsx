        ...
        <div id='about' className='w-full md:h-screen bg-gradient-to-r from-[#38b9da] to-[#e74e4e] p-2 flex items-center py-16'>
            <div className='  max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
                <div className='col-span-2'>
                    ...
                    <h2 className='text-gray-100 py-4'>Who I Am</h2>
                    <p className='py-2 text-gray-100'>I am a freelance software and chatbot developer with a B.Sc in Computer Science and 2years experience in javascript. I have developed Websites and Chatbots for various businesses</p>
