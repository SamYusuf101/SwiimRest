     ...
     <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        <div className='col-span-4'>
           <p>Project</p>
           <h2>Overview</h2>
           <p>This cross-platform mobile application lets you read news in real time. Default Country news is set to United States. </p>
        <Link href = 'https://github.com/SamYusuf101/NewsApp' >
